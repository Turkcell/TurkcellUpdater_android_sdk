...
public class Message implements Serializable {
    ...
    Message(MessageDescription description, URL targetWebsiteUrl, boolean targetGooglePlay, String targetPackageName) {
        super();
    ...
    public String toString() {
        return "Message [description=" + description + ", targetWebsiteUrl=" + targetWebsiteUrl + ", targetGooglePlay=" + targetGooglePlay + ", targetPackageName=" + targetPackageName + "]";
    }
}
