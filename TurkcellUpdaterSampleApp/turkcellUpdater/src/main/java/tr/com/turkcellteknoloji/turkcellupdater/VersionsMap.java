...
class VersionsMap {
    ...
    Update getUpdate(Properties currentProperties, UpdateDisplayRecords records, Context context) throws UpdaterException {
        ...
        for (UpdateEntry updateEntry : updateEntries) {
            ...
            try {
                if (updateEntry.shouldDisplay(currentProperties, records, context)) {
                    return updateEntry.getUpdate(currentProperties, records);
                }
            } catch (Exception e) {
